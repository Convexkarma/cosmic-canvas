    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are an expert educator. Given a topic, generate 36-48 high-quality flashcards organized into 6-8 subtopics, with 5-8 cards per subtopic. Each card must be substantive, specific, and non-redundant — go deep into fundamentals, intermediate concepts, advanced topics, real-world applications, history, edge cases, common misconceptions, and notable examples. Avoid surface-level or duplicate questions. Return ONLY a valid JSON object (no markdown, no code fences) with this exact structure:
{
  "topic": "the topic",
  "cards": [
    {
